...
class EntityCapabilitiesModuleTest {
    ...
    fun test_validateVerificationString() {
        val info = halcyon.getModule(DiscoveryModule).buildInfo(
            iq {
                type = IQType.Result
    ...
    fun testCalculateVerificationString() {
        val module =
            EntityCapabilitiesModule(
                halcyon,
                DiscoveryModule(halcyon),
                StreamFeaturesModule(halcyon)
            )
    ...
    fun testComplexGenerationVerificationString() {
        ...
        assertEquals(
            ...
            module.calculateVer(identities, features, listOf(form))
        )
    }
}
