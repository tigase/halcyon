...
class VCardBuilderTest {
    ...
    fun testVCardBuild() {
        ...
        assertEquals(
            "132",
            c.element.findChild("vcard", "adr", "parameters", "pref", "integer")?.value
        )
        assertEquals(
            "home",
            c.element.findChild("vcard", "adr", "parameters", "type", "text")?.value
        )
        ...
        assertEquals(
            "work",
            c.element.findChild("vcard", "org", "parameters", "type", "text")?.value
        )
