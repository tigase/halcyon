...
interface JIDPasswordSaslConfig :
    SaslConfig,
    UserJIDProvider {
...
class JIDPasswordAuthConfigBuilder : ConfigItemBuilder<JIDPasswordAuthConfig> {
    ...
    override fun build(root: ConfigurationBuilder): JIDPasswordAuthConfig = JIDPasswordAuthConfig(
        userJID = userJID ?: throw ConfigurationException("User JID not specified."),
        passwordCallback =
        passwordCallback ?: throw ConfigurationException("Password not specified."),
