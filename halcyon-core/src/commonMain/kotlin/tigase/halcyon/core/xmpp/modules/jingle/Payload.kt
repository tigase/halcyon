...
class Payload(
    ...
    fun toElement(): Element = element("payload-type") {
    ...
    class Parameter(val name: String, val value: String) {
        ...
        fun toElement(): Element = element("parameter") {
    ...
    class RtcpFeedback(val type: String, val subtype: String?) {
        ...
        fun toElement(): Element = element("rtcp-fb") {
        ...
        companion object {
            ...
            fun parse(el: Element): RtcpFeedback? {
                if ("rtcp-fb".equals(el.name) &&
                    "urn:xmpp:jingle:apps:rtp:rtcp-fb:0".equals(el.xmlns)
                ) {
