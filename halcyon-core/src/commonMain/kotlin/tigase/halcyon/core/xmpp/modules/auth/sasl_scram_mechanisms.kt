...
class SASLScramSHA1 :
    ...
    companion object : SASLMechanismProvider<SASLScramSHA1, SASLScramConfig> {
        ...
        override fun configure(mechanism: SASLScramSHA1, cfg: SASLScramConfig.() -> Unit) =
            mechanism.cfg()
    }
}

class SASLScramSHA1Plus :
    AbstractSASLScramPlus(
        name = NAME,
        hashAlgorithm = ScramHashAlgorithm.SHA1
    ) {
    companion object : SASLMechanismProvider<SASLScramSHA1Plus, SASLScramConfig> {
        ...
        override fun configure(mechanism: SASLScramSHA1Plus, cfg: SASLScramConfig.() -> Unit) =
            mechanism.cfg()
    }
}
...
class SASLScramSHA256 :
    ...
    companion object : SASLMechanismProvider<SASLScramSHA256, SASLScramConfig> {
        ...
        override fun configure(mechanism: SASLScramSHA256, cfg: SASLScramConfig.() -> Unit) =
            mechanism.cfg()
    }
}

class SASLScramSHA256Plus :
    AbstractSASLScramPlus(
        name = NAME,
        hashAlgorithm = ScramHashAlgorithm.SHA256
    ) {
    companion object : SASLMechanismProvider<SASLScramSHA256Plus, SASLScramConfig> {
        ...
        override fun configure(mechanism: SASLScramSHA256Plus, cfg: SASLScramConfig.() -> Unit) =
            mechanism.cfg()
    }
}
...
class SASLScramSHA512 :
    ...
    companion object : SASLMechanismProvider<SASLScramSHA512, SASLScramConfig> {
        ...
        override fun configure(mechanism: SASLScramSHA512, cfg: SASLScramConfig.() -> Unit) =
            mechanism.cfg()
    }
}

class SASLScramSHA512Plus :
    AbstractSASLScramPlus(
        name = NAME,
        hashAlgorithm = ScramHashAlgorithm.SHA512
    ) {
    companion object : SASLMechanismProvider<SASLScramSHA512Plus, SASLScramConfig> {
        ...
        override fun configure(mechanism: SASLScramSHA512Plus, cfg: SASLScramConfig.() -> Unit) =
            mechanism.cfg()
    }
}
