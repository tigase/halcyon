...
class StreamFeaturesModule : tigase.halcyon.core.modules.XmppModule {
	...
	companion object {
		...
		fun getFeatures(sessionObject: tigase.halcyon.core.SessionObject): Element? = sessionObject.getProperty<Element>(FEATURES_KEY)
	...
	override val criteria = tigase.halcyon.core.modules.Criterion.and(
		tigase.halcyon.core.modules.Criterion.name("features"), tigase.halcyon.core.modules.Criterion.xmlns("http://etherx.jabber.org/streams")
	)
