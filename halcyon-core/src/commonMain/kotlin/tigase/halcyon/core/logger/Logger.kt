...
object LoggerFactory {
    ...
    fun logger(name: String, enabled: Boolean = true): Logger =
        LoggerWrapper(spiFactory.invoke(name, enabled))
}
...
interface Logger {
    ...
    fun fine(caught: Throwable? = null, msg: () -> Any?) =
        log(level = Level.FINE, caught = caught, msg = msg)
    fun finer(caught: Throwable? = null, msg: () -> Any?) =
        log(level = Level.FINER, caught = caught, msg = msg)
    fun finest(caught: Throwable? = null, msg: () -> Any?) =
        log(level = Level.FINEST, caught = caught, msg = msg)

    fun config(caught: Throwable? = null, msg: () -> Any?) =
        log(level = Level.CONFIG, caught = caught, msg = msg)
    fun info(caught: Throwable? = null, msg: () -> Any?) =
        log(level = Level.INFO, caught = caught, msg = msg)
    fun warning(caught: Throwable? = null, msg: () -> Any?) =
        log(level = Level.WARNING, caught = caught, msg = msg)
    fun severe(caught: Throwable? = null, msg: () -> Any?) =
        log(level = Level.SEVERE, caught = caught, msg = msg)
}
