...
sealed class SocketConnectionErrorEvent : ConnectionErrorEvent() {
    ...
    class Unknown(val caught: nw_error_t?) : SocketConnectionErrorEvent() {
        ...
        override fun toString(): String =
            "tigase.halcyon.core.connector.socket.SocketConnectionErrorEvent.Unknown:NWERROR:" +
    ...
    override fun stop() {
        if ((state != State.Disconnected)) {
            ...
            try {
                ...
                dispatch_after(
                    dispatch_time(DISPATCH_TIME_NOW, 10L * NSEC_PER_MSEC.toLong()),
                    queue
                ) {
