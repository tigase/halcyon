            ...
            try {
                ...
                if (e is SignalException) {
                    when (e.error) {
                        ...
                        SignalError.invalidMessage, SignalError.noSession, SignalError.noSession -> healSession(
                            senderAddr
                        )
                        else -> {}
                    }
                ...
                log.warning(e, {
                    "failed to decrypt key for " + sessionCipher.address + ", store = " +
                        sessionCipher.store +
                        ", error: " +
                        e.cause
                })
    ...
    actual fun decrypt(
        ...
        try {
            ...
            ciphertext?.let { ciphertext ->
                ...
                val newCipherText = ciphertext.copyOf().plus(
                    key.copyOfRange(16, 16 + authtaglength)
                )
