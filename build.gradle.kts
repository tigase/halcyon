...
allprojects {
    ...
    version =
        insertBuildNumber(
            ...
            "git rev-list --count HEAD".runCommand(File("./"))
        )
}
        ...
        publishing {
            repositories {
                maven {
                    ...
                    credentials {
                        username =
                            props["mavenUsername"]?.toString()
                                ?: findProperty("mavenUsername").toString()
                        password =
                            props["mavenPassword"]?.toString()
                                ?: findProperty("mavenPassword").toString()
                    }
                }
            }
        }
